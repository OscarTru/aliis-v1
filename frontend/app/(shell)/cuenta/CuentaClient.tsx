...
export function CuentaClient({
  ...
  const [isGoogleUser] = useState(initialIsGoogleUser)

  // Name
  const [name, setName] = useState(initialProfile.name || googleName)
  ...
  // Who
  const [who, setWho] = useState<'yo' | 'familiar' | null>(initialProfile.who ?? null)
