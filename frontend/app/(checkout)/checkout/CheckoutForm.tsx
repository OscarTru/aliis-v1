  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full max-w-sm mx-auto">
      ...
      <div className="flex items-center justify-center gap-2 text-muted-foreground/40">
        ...
        <svg viewBox="0 0 60 25" fill="currentColor" aria-label="Stripe" className="h-[11px] w-auto">
          <path d="M59.64 14.28h-8.06c.19 1.93 1.6 2.55 3.2 2.55 1.64 0 2.96-.37 4.05-.95v3.32a8.33 8.33 0 0 1-4.56 1.1c-4.01 0-6.83-2.5-6.83-7.48 0-4.19 2.39-7.52 6.3-7.52 3.92 0 5.96 3.28 5.96 7.5 0 .4-.04 1.26-.06 1.48zm-5.92-5.62c-1.03 0-2.17.73-2.17 2.58h4.25c0-1.85-1.07-2.58-2.08-2.58zm-18.84 5.62h-8.06c.19 1.93 1.6 2.55 3.2 2.55 1.64 0 2.96-.37 4.05-.95v3.32a8.33 8.33 0 0 1-4.56 1.1c-4.01 0-6.83-2.5-6.83-7.48 0-4.19 2.39-7.52 6.3-7.52 3.92 0 5.96 3.28 5.96 7.5 0 .4-.04 1.26-.06 1.48zm-5.92-5.62c-1.03 0-2.17.73-2.17 2.58h4.25c0-1.85-1.07-2.58-2.08-2.58zM.86 7.18h3.54l.07.9C5.42 7.35 6.64 7 7.9 7c3.67 0 5.2 2.87 5.2 7.28 0 4.81-2.04 7.32-5.6 7.32-1.08 0-2.16-.33-2.95-.85v5.85H.86V7.18zm7.56 11.06c1.26 0 1.93-1.07 1.93-3.82 0-2.73-.67-3.8-1.93-3.8-.59 0-1.23.23-1.76.59v6.58c.5.32 1.1.45 1.76.45zm18.06-11.06h3.67v13.95H26.48v-1.16c-.68.86-1.64 1.38-2.95 1.38-2.77 0-4.65-2.35-4.65-7.14 0-4.93 2.1-7.28 4.86-7.28 1.17 0 2.14.46 2.74 1.25V7.18zm0 10.15v-6.3c-.47-.38-1.04-.6-1.64-.6-1.26 0-1.93 1.1-1.93 3.82 0 2.75.61 3.75 1.7 3.75.68 0 1.33-.27 1.87-.67zm6.49-10.15h3.67v13.95h-3.67V7.18zm0-4.97h3.67v3.27h-3.67V2.21z"/>
        </svg>
      </div>
    </form>
  )
