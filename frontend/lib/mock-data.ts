...
export const PRICING_TIERS: { gratis: PricingTier; pro: PricingTier } = {
  ...
  pro: {
    ...
    features: [
      ...
      { included: true, text: 'Asistente IA con memoria y streaming', sub: 'modelo más rápido, recuerda tu contexto' },
      { included: true, text: 'Preparar consulta con tu médico', sub: 'resumen listo para llevar a la cita' },
      { included: true, text: 'Detector de inconsistencias', sub: 'avisa si un diagnóstico no tiene tratamiento, o al revés' },
      { included: true, text: 'Análisis de correlación síntoma-vital', sub: 'cruza tu diario con tu presión, glucosa, peso' },
      { included: true, text: 'El Hilo: análisis longitudinal', sub: 'tu diario convertido en un resumen mensual' },
      { included: true, text: 'Cápsula del tiempo mensual', sub: 'comparativa de vitales con el mes anterior' },
      { included: true, text: 'Todo lo de Gratis incluido', sub: 'diario, tratamientos, biblioteca, compartir' },
    ],
