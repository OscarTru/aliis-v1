...
export const PRICING_TIERS: { gratis: PricingTier; pro: PricingTier } = {
  gratis: {
    ...
    features: [
      { included: true, text: '2 expedientes por semana', sub: 'para entender un diagnóstico puntual' },
      { included: true, text: 'Referencias verificables (PubMed, DOI)', sub: 'cada afirmación con su fuente' },
      { included: true, text: 'Biblioteca de diagnósticos', sub: 'más de 60 condiciones revisadas' },
      { included: true, text: 'Diario de síntomas', sub: 'registra cómo te sientes día a día' },
      { included: true, text: 'Control de tratamientos', sub: 'adherencia y racha de medicación' },
      { included: true, text: 'Asistente IA (5 preguntas/día)', sub: 'pregunta lo que no quedó claro' },
      { included: true, text: 'Historial 30 días', sub: 'tus últimos expedientes siempre disponibles' },
      { included: false, text: 'Expedientes ilimitados' },
      { included: false, text: 'Asistente IA ilimitado' },
      { included: false, text: 'Preparar consulta con tu médico' },
      { included: false, text: 'Historial permanente' },
    ],
  ...
  pro: {
    ...
    features: [
      { included: true, text: 'Expedientes ilimitados', sub: 'sin contadores, sin fricción' },
      { included: true, text: 'Asistente IA ilimitado', sub: 'pregunta cuanto quieras, sin tope diario' },
      { included: true, text: 'Preparar consulta con tu médico', sub: 'resumen para llevar a la cita' },
      { included: true, text: 'Diario de síntomas y tratamientos', sub: 'todo incluido, igual que en Gratis' },
      { included: true, text: 'Historial permanente', sub: 'todos tus expedientes siempre disponibles' },
      { included: true, text: 'Compartir tu expediente', sub: 'enlaces de solo lectura para quien quieras' },
      { included: true, text: 'Soporte prioritario', sub: 'respondemos en menos de 24 h' },
    ],
