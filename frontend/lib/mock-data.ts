...
export const PRICING_TIERS: { gratis: PricingTier; pro: PricingTier } = {
  gratis: {
    ...
    features: [
      ...
      { included: true, text: 'Referencias verificables', sub: 'cada afirmación con su fuente — PubMed, DOI, guías clínicas' },
      { included: true, text: 'Pregúntale a Aliis', sub: 'aclara dudas sobre tu diagnóstico cuando quieras' },
      { included: true, text: 'Diario de síntomas y vitales', sub: 'glucosa, presión, peso, FC — todo en un lugar' },
      { included: true, text: 'Tus tratamientos organizados', sub: 'dosis, horarios y racha de adherencia' },
      { included: true, text: 'Biblioteca de condiciones', sub: 'más de 60 diagnósticos revisados por especialistas' },
    ],
  ...
  pro: {
    ...
    features: [
      { included: true, text: 'Explicaciones sin límite', sub: 'y más profundas — Aliis analiza tu caso con más detalle' },
      { included: true, text: 'Aliis te conoce de verdad', sub: 'usa tu historial, tus medicamentos y tus vitales al responder' },
      ...
      { included: true, text: 'Prepara tu próxima consulta', sub: 'un resumen claro con las preguntas concretas para llevar al médico' },
      { included: true, text: 'Ve los patrones de tu salud', sub: 'cómo se relacionan tus síntomas con tus vitales a lo largo del tiempo' },
      { included: true, text: 'Tu resumen mensual', sub: 'cómo evolucionaste este mes — en lenguaje humano, no en números' },
    ],
