...
export const PRICING_TIERS: { gratis: PricingTier; pro: PricingTier } = {
  gratis: {
    ...
    features: [
      ...
      { included: false, text: 'Mi diario — síntomas y apuntes' },
      { included: false, text: 'Asistente IA por capítulo' },
      { included: false, text: 'Compartir tu expediente' },
  ...
  pro: {
    ...
    features: [
      ...
      { included: true, text: 'Referencias con DOI, PubMed y guías clínicas', sub: 'desplegables en cada capítulo' },
      { included: true, text: 'Mi diario', sub: 'registra síntomas, signos y apuntes por diagnóstico' },
      { included: true, text: 'Asistente IA por capítulo', sub: 'pregunta lo que no quedó claro' },
      { included: true, text: 'Biblioteca completa de diagnósticos', sub: 'revisados por especialistas' },
      { included: true, text: 'Compartir tu expediente', sub: 'con familiares, pareja o médicos' },
      { included: true, text: 'Historial permanente', sub: 'todos tus diagnósticos siempre disponibles' },
