...
export const PRICING_TIERS: { gratis: PricingTier; pro: PricingTier } = {
  gratis: {
    ...
    features: [
      { included: true, text: '1 explicación por semana', sub: 'capítulos completos con referencias' },
      { included: true, text: 'Asistente IA por capítulo', sub: 'pregunta lo que no quedó claro' },
      { included: true, text: 'Diario de síntomas y vitales', sub: 'registra cómo te sientes cada día' },
      { included: true, text: 'Control de tratamientos', sub: 'dosis, horarios y adherencia' },
      { included: true, text: 'Validación IA de dosis', sub: 'al añadir cada medicamento' },
      { included: true, text: 'Biblioteca de diagnósticos', sub: 'más de 60 condiciones revisadas' },
      { included: true, text: 'Compartir tu explicación', sub: 'enlace de solo lectura, 30 días' },
      { included: true, text: 'Historial permanente', sub: 'tus explicaciones, siempre disponibles' },
    ],
  ...
  pro: {
    ...
    cadence: 'al mes',
    pitch: 'Para quien quiere profundidad real y que Aliis aprenda de sus datos.',
    features: [
      { included: true, text: 'Modelos Anthropic de mayor capacidad', sub: 'explicaciones más profundas y con más matiz clínico' },
      { included: true, text: 'Explicaciones ilimitadas', sub: 'sin contadores, sin fricción' },
      { included: true, text: 'Explicaciones personalizadas a tu perfil', sub: 'usa tus medicamentos, alergias y condiciones previas' },
      { included: true, text: 'Agente Aliis con contexto completo', sub: 'recuerda tu historial y tus vitales en cada conversación' },
      { included: true, text: 'Notificaciones proactivas', sub: 'AliisCore analiza tus datos cada mañana' },
      { included: true, text: 'Preparar consulta con tu médico', sub: 'resumen listo para llevar a la cita' },
      { included: true, text: 'Análisis de correlación síntoma-vital', sub: 'cruza tu diario con presión, glucosa, peso, FC' },
      { included: true, text: 'El Hilo: análisis longitudinal', sub: 'tu diario convertido en un resumen mensual' },
      { included: true, text: 'Detector de inconsistencias dx ↔ tratamiento', sub: 'avisa si algo no cuadra entre diagnósticos y medicamentos' },
      { included: true, text: 'Todo lo de Gratis incluido', sub: 'diario, tratamientos, biblioteca, compartir, historial' },
    ],
