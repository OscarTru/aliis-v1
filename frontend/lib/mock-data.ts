...
export const PRICING_TIERS: { gratis: PricingTier; pro: PricingTier } = {
  gratis: {
    ...
    features: [
      ...
      { included: true, text: 'Compartir tu expediente', sub: 'con familiares o tu médico' },
      ...
      { included: false, text: 'Asistente IA por capítulo' },
  ...
  pro: {
    ...
    features: [
      ...
      { included: true, text: 'Todo lo de Gratis incluido', sub: 'diario, tratamientos, referencias, biblioteca' },
