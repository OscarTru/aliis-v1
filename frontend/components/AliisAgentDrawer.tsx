  ...
  return (
    <>
      ...
      >
        ...
        <div className="pointer-events-none absolute bottom-[calc(4.5rem+env(safe-area-inset-bottom))] left-0 right-0 h-10 bg-gradient-to-t from-background to-transparent z-10" />
