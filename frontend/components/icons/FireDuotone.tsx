/**
 * Inlined SVG of solar:fire-bold-duotone (https://icon-sets.iconify.design/solar/fire-bold-duotone/).
 *
 * Inlined instead of pulled via @iconify/react so we don't need to allow
 * api.iconify.design in CSP connect-src and so it works offline / under any
 * runtime environment. Use color via `text-*` Tailwind classes — both paths
 * use fill="currentColor".
 */
export function FireDuotone({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
