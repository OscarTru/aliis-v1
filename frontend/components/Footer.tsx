        ...
        <div className="flex items-start justify-between flex-wrap gap-8 mb-12">
          <div className="max-w-[28rem]">
            <div className="flex items-center gap-3 mb-4">
              <Image src="/assets/aliis-original.png" alt="Aliis" width={90} height={36} className="object-contain dark:hidden" />
              <Image src="/assets/aliis-black.png" alt="Aliis" width={90} height={36} className="object-contain hidden dark:block dark:invert" />
            </div>
