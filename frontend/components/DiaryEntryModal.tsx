        ...
        {step === 'write' && (
          <div className="flex flex-col gap-4 pt-2">
            ...
            <textarea
              ...
              autoFocus
              maxLength={2000}
              className="w-full rounded-xl border border-border bg-background px-3 py-2.5 font-sans text-[14px] text-foreground focus:outline-none focus:border-foreground/30 resize-none leading-relaxed"
            />
            ...
            <div className="flex gap-2">
              <button
                onClick={handleClose}
                className="px-4 py-2.5 rounded-full border border-border bg-transparent font-sans text-[13px] text-muted-foreground cursor-pointer hover:bg-muted transition-colors"
              >
                Cancelar
              </button>
              <button
