  ...
  return (
    <Dialog open onOpenChange={(o) => { if (!o) onClose() }}>
      <DialogPortal>
        ...
        <div
          className="relative w-full sm:max-w-[480px] bg-background rounded-2xl border border-border shadow-xl flex flex-col max-h-[85vh] overflow-hidden pointer-events-auto"
        >
          ...
          <div className="flex flex-col gap-4">
            <div className="flex gap-2">
              <div className="flex-1">
                ...
                <input
                  className="h-11 w-full min-w-0 truncate rounded-xl border border-border bg-muted px-3 font-sans text-[16px] text-foreground placeholder:text-[13px] placeholder:text-muted-foreground/70 focus:outline-none focus:border-primary/50"
